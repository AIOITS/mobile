...
const SuccessTambahSTNK = () => {
  ...
  return (
    <ConfirmMessage
      ...
      header="Peminjaman STNK telah diajukan"
      subHeader="Harap menunggu pemilik STNK untuk mengkonfirmasi pengajuan">
      <Icon
        name="checkcircle"
        type="antdesign"
        size={80}
...
export default SuccessTambahSTNK;
